    ...
    <div id="orderModal" class="modal">
        <div class="modal-content">
            ...
            <?php if(!empty($orders)): ?>
                ...
                <form id="courierOrderDetails" action="<?= ROOT ?>/CourierAcceptedOrderDetails/update" enctype="multipart/form-data" method="POST">
                ...
                <button type="submit" class="accept-button">Deliverying</button>
