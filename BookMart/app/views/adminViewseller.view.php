    ...
    <div class="box">
        <div class="user-info">
            <div class="info-row">
                ...
                <span class="value" id="userName">R.K.L Piyumi</span>
            </div>
            <div class="info-row">
                <span class="label">Seller ID:</span>
                <span class="value" id="sellerId">S001</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="value" id="email">piyumibooks167@gmail.com</span>
            </div>
            <div class="info-row">
