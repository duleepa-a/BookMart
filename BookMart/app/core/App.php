...
class App{
    ...
    private $roleAccess = [
        'admin' => [
            ...
            'Admin' => ['index','bookstoreView','viewBookStore','approve','reject','downloadEvidenceDoc','downloadCourierDoc','viewCourier','payRolls','markAsResolve','addRefund','updateRefundStatus','deleteRefundRequest' ,'settleAllPayrolls','downloadRefundEvdience'],
    ...
    private $publicAccess = [
        ...
        'User' => ['login','logout','registerBuyer','registerCourier','registerBookSeller','registerBookStore','checkusername','checkemail','termsConditions' ,'privacyAndPolicies','aboutUs'],
        'Loading' => ['index'],
